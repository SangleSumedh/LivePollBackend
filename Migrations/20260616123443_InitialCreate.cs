        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveQuestionIndex = table.Column<int>(type: "integer", nullable: false, defaultValue: -1),
                    CurrentQuestionActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoteCounts_Polls_PollId",
                        column: x => x.PollId,
                        principalTable: "Polls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoteCounts_PollId_QuestionIndex_OptionIndex",
                table: "VoteCounts",
                columns: new[] { "PollId", "QuestionIndex", "OptionIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Votes_PollId_QuestionIndex_SessionId",
                table: "Votes",
                columns: new[] { "PollId", "QuestionIndex", "SessionId" },
                unique: true);
        }
